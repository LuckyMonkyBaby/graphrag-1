...
class CloudStorageFactory:
    ...
    async def _create_opensearch_store(config: CloudStorageConfig) -> Any:
        ...
        try:
            ...
            raise ImportError(
                "AWS OpenSearch dependencies not installed. Install with: pip install opensearch-py boto3"
            )
    ...
    async def _create_neptune_store(config: CloudStorageConfig) -> Any:
        ...
        try:
            ...
            raise ImportError(
                "AWS Neptune dependencies not installed. Install with: pip install gremlinpython boto3"
            )
    ...
    async def _create_rds_store(config: CloudStorageConfig) -> Any:
        ...
        try:
            ...
            raise ImportError(
                "AWS RDS dependencies not installed. Install with: pip install psycopg2-binary boto3"
            )
    ...
    async def _create_azure_blob_storage(config: CloudStorageConfig) -> PipelineStorage:
        ...
        try:
            ...
            raise ImportError(
                "Azure dependencies not installed. Install with: pip install azure-storage-blob"
            )
    ...
    async def _create_azure_search_store(config: CloudStorageConfig) -> Any:
        ...
        try:
            ...
            raise ImportError(
                "Azure AI Search dependencies not installed. Install with: pip install azure-search-documents"
            )
    ...
    async def _create_cosmos_gremlin_store(config: CloudStorageConfig) -> Any:
        ...
        try:
            from graphrag.graph_stores.azure_cosmos_gremlin import (
                AzureCosmosGremlinStore,
            )
            ...
            raise ImportError(
                "Azure Cosmos DB dependencies not installed. Install with: pip install gremlinpython azure-cosmos"
            )
    ...
    async def _create_cosmosdb_store(config: CloudStorageConfig) -> Any:
        ...
        try:
            from graphrag.storage.cosmosdb_pipeline_storage import (
            ...
            raise ImportError(
                "Azure Cosmos DB dependencies not installed. Install with: pip install azure-cosmos"
            )
    ...
    async def _create_lancedb_store(config: CloudStorageConfig) -> Any:
        ...
        try:
            from graphrag.vector_stores.enhanced_lancedb import (
                EnhancedLanceDBVectorStore,
            )
            ...
            raise ImportError(
                "LanceDB dependencies not installed. Install with: pip install lancedb"
            )
    ...
    async def _create_pinecone_store(config: CloudStorageConfig) -> Any:
        ...
        try:
            ...
            raise ImportError(
                "Pinecone dependencies not installed. Install with: pip install pinecone-client"
            )
