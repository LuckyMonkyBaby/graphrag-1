...
def extract_source_attributions(
    ...
    if "sources" in context_records:
        ...
        for _, source in used_sources.iterrows():
                ...
                for doc_id in documents:
                    if doc_id in document_metadata:
                        ...
                        file_info.append({
                            ...
                            "filename": doc_meta.get("filename") or doc_meta.get("title"),
            ...
            if pd.notna(source.get(PARAGRAPH_ID)) or pd.notna(source.get(PARAGRAPH_NUMBER)):
            ...
            if pd.notna(source.get(CHAR_POSITION_START)) or pd.notna(source.get(CHAR_POSITION_END)):
...
def create_citation_metadata(
    ...
    metadata = {
        ...
        "has_character_positions": any("character_position" in attr for attr in attributions),
    }
